...
* An optional dynamic routing gateway _[Deprecated; use the drg submodule instead]_
* An optional remote peering connection _[Deprecated; use the drg submodule instead]_
